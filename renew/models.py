...
class Property(models.Model):
	...
	nsp = models.NullBooleanField(default=False, null=True, help_text="If a property comes with requirements related to the Neighborhood Stabilization Program.", verbose_name='NSP')
